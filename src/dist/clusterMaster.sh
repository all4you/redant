...
##############################################################################
##
##  redant start up script for UN*X
##
##############################################################################
...
APP_NAME="redant_master"
MAIN_CLASS="com.redant.cluster.master.MasterServerBootstrap"
...
eval set -- $DEFAULT_JVM_OPTS $JAVA_OPTS $REDANT_OPTS -classpath "\"$CLASSPATH\"" $MAIN_CLASS "$APP_ARGS"
