 ...
 * @create 2017-10-20
 */
public final class PrimitiveTypeConverter extends AbstractSimpleTypeConverter {
	
	private static final PrimitiveTypeConverter convertor;
	static {
		convertor = new PrimitiveTypeConverter();
	}
